document.addEventListener('DOMContentLoaded', function () {
    ...
    window.alerts = {
        ...
        showSuccess: function(message, title = "¡Éxito!") {
            ...
            const alertPath = window.location.pathname.includes('/') ? '/assets/alerts/succesfull.html' : 'assets/alerts/succesfull.html';
        ...
        showError: function(message, title = "Error") {
            const alertPath = window.location.pathname.includes('/') ? '/assets/alerts/error.html' : 'assets/alerts/error.html';
            _loadAlert(alertPath, title, message);
        },
        ...
        showWarning: function(message, title = "Advertencia") {
            const alertPath = window.location.pathname.includes('/') ? '/assets/alerts/warning.html' : 'assets/alerts/warning.html';
            _loadAlert(alertPath, title, message);
        }
    };
